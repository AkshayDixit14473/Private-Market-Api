...
for x in column:
 try:
    print(x)
    ticker=x
    #api_url=f'https://api.polygon.io/v2/aggs/ticker/{ticker}/range/1/minute/2018-01-01/2018-07-01?adjusted=true&sort=asc&limit=50000&apiKey=<key>'
    api_url=f'https://api.polygon.io/v2/aggs/ticker/{ticker}/range/1/day/2018-01-01/2022-11-01?adjusted=true&sort=asc&limit=50000&apiKey=<key>'
    ...
    df.to_csv("/home/akshay/Downloads/alpaca/"+ticker+".csv",index=False, sep=',')
    #print(df)
    #f = open("/home/akshay/Downloads/alpaca/"+ticker, "w")
    #f.write(df)
    #f.close()
