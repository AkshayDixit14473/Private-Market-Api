...
ticker='Megacsv.csv'
api_key='d48a7c3586d748a6a5589426b333498f'
interval = '1day'
...
for x in column:
 try:
    print(x)
    ticker=x
    api_url=f'https://api.polygon.io/v2/aggs/ticker/{ticker}/range/1/minute/{sdate}/{edate}?adjusted=true&sort=asc&limit=50000&apiKey=Kh6pQ50hBPUmltmd9KhQgsKaqjVmPvMk'
